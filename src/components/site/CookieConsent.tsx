...
export function CookieConsent() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[70] p-4 md:p-6">
      <div className="mx-auto max-w-4xl rounded-3xl border border-ink/10 bg-white p-5 text-ink shadow-xl md:p-7">
        <p className="text-[11px] tracking-[0.2em] text-jade uppercase">Cookies and privacy</p>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-6 text-ink/70">
          ...
          <Link href="/cookies" className="underline decoration-ink/30 hover:decoration-ink">
            Cookie policy
          </Link>{" "}
          and{" "}
          <Link href="/privacy" className="underline decoration-ink/30 hover:decoration-ink">
            Privacy notice
          </Link>
          .
        </p>
        ...
        {panel === "customize" && (
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
            <label className="rounded-2xl border border-ink/10 p-4 text-sm">
            ...
            {(
              ...
              <label key={key} className="rounded-2xl border border-ink/10 p-4 text-sm">
                <input
                  type="checkbox"
                  checked={draft[key]}
        ...
        <div className="mt-5 flex flex-wrap gap-2">
          <button
            ...
            className="rounded-full bg-ink px-4 py-2 text-[11px] tracking-[0.16em] text-white uppercase"
          >
            Accept all
          </button>
          <button
            ...
            className="rounded-full border border-ink/20 px-4 py-2 text-[11px] tracking-[0.16em] uppercase"
          >
